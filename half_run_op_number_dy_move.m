...
% Functions
t_move_f = simu_t_move_exp(T_MOVE_WAIT_COEF);
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
	'Location', 'southeast');
saveas(gcf, 'fig/half_op_number_dy_move_asap.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
	'Location', 'southeast');
saveas(gcf, 'fig/half_op_number_dy_move_alg4.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
	'Location', 'southeast');
saveas(gcf, 'fig/half_op_number_dy_move_ga.fig');
...
% legend('Strict static plan', 'Strict timeline', 'Control theory', ...
% 	'Location', 'southeast');
% saveas(gcf, 'fig_2/half_op_number_dy_move_high_asap.fig');
...
% legend('Strict static plan', 'Strict timeline', 'Control theory', ...
% 	'Location', 'southeast');
% saveas(gcf, 'fig_2/half_op_number_dy_move_high_alg4.fig');
...
% legend('Strict static plan', 'Strict timeline', 'Control theory', ...
% 	'Location', 'southeast');
% saveas(gcf, 'fig_2/half_op_number_dy_move_high_ga.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_op_number_dy_move_length_asap.fig');
...
ylabel('Time to complete all data collection (sec)');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_op_number_dy_move_length_alg4.fig');
...
ylabel('Time to complete all data collection (sec)');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_op_number_dy_move_length_ga.fig');

save('mat/half_op_number_dy_move.mat')
