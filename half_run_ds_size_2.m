...
for j = 1:nm_ds
    ...
    for k = 1:N_LOOP
        mat_prefix = sprintf('half/change_ds_size_2/%d/case_%d/', ...
            size_of_ds(j), k);
        loop_j = k + (j - 1)* N_LOOP;
...
saveas(gcf, 'fig/half_ds_size_2_asap.fig');
...
ylabel('Weighted overall utility');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig/half_ds_size_2_alg4.fig');
...
ylabel('Weighted overall utility');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig/half_ds_size_2_ga.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_ds_size_2_high_asap.fig');
...
ylabel('Portion of important data chunks uploaded');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_ds_size_2_high_alg4.fig');
...
ylabel('Portion of important data chunks uploaded');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_ds_size_2_high_ga.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_ds_size_2_length_asap.fig');
...
ylabel('Time to complete all data collection (sec)');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_ds_size_2_length_alg4.fig');
...
ylabel('Time to complete all data collection (sec)');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_ds_size_2_length_ga.fig');
