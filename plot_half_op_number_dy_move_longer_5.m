for lv = 0:5
    load(sprintf('mat/half_op_number_dy_move_longer_%d.mat', lv));
    ...
    legend('First opportunity', 'Balanced DOP', 'Genetic algorithm', ...
        ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_x_dy_move_longer_%d.fig', lv));
    ...
    legend('First opportunity', 'Balanced DOP', 'Genetic algorithm', ...
        'BDOP-Lyapunov', 'GA-Lyapunov', ...
        'Location', 'northwest');
    saveas(gcf, sprintf('fig_3/half_op_number_length_x_dy_move_longer_%d.fig', lv));
end
