% Author: Charles ZHU
% --
% Experimental: Noises are added to data chunks instead of up bandwidth
...
for data_change_hrp_10 = 0:1:5
    ...
    % Set level of data dynamics, "hrp" stands for half_range_percent
    data_change_hrp = data_change_hrp_10 / 10;
    ds_data_change_f = simu_change_data_uniform_percent_bigger( ...
        data_change_hrp);
    run_fx = @(get_next_item_f) run_dy_data_3(BASIC_WAIT, ...
    ...
    fprintf(sprintf('Using percent range %.2f...\n\n', data_change_hrp_10));
    ...
    saveas(gcf, sprintf('fig_3/half_ds_size_dy_data_bigger_%d_asap.fig', ...
        data_change_hrp_10));
    ...
    ylabel('Weighted overall utility');
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_ds_size_dy_data_bigger_%d_alg4.fig', ...
        data_change_hrp_10));
    ...
    ylabel('Weighted overall utility');
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_ds_size_dy_data_bigger_%d_ga.fig', ...
        data_change_hrp_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
    	'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_ds_size_dy_data_bigger_%d_high_asap.fig', ...
        data_change_hrp_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
    	'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_ds_size_dy_data_bigger_%d_high_alg4.fig', ...
        data_change_hrp_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
    	'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_ds_size_dy_data_bigger_%d_high_ga.fig', ...
        data_change_hrp_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_ds_size_dy_data_bigger_%d_length_asap.fig', ...
        data_change_hrp_10));
    ...
    ylabel('Time to complete all data collection (sec)');
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_ds_size_dy_data_bigger_%d_length_alg4.fig', ...
        data_change_hrp_10));
    ...
    ylabel('Time to complete all data collection (sec)');
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_ds_size_dy_data_bigger_%d_length_ga.fig', ...
        data_change_hrp_10));

    save(sprintf('mat/half_ds_size_dy_data_bigger_%d.mat', data_change_hrp_10))
end
