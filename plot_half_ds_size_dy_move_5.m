for lv = 0:5
    load(sprintf('mat/half_ds_size_dy_move_%d.mat', lv));
    ...
    legend('First opportunity', 'Balanced DOP', 'Genetic algorithm', ...
        ...
        'Location', 'southwest');
    saveas(gcf, sprintf('fig_3/half_ds_size_x_dy_move_%d.fig', lv));
    ...
    legend('First opportunity', 'Balanced DOP', 'Genetic algorithm', ...
        'BDOP-Lyapunov', 'GA-Lyapunov', ...
        'Location', 'northwest');
    saveas(gcf, sprintf('fig_3/half_ds_size_length_x_dy_move_%d.fig', lv));
    ...
    legend('First opportunity', 'Balanced DOP', 'Genetic algorithm', ...
        'BDOP-Lyapunov', 'GA-Lyapunov', ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_ds_size_stdev_x_dy_move_%d.fig', lv));
end
