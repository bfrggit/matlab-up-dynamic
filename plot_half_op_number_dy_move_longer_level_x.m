...
plot(number_of_op, reward_total_box(:, 1, 4), 'b', ...
    number_of_op, reward_total_box(:, 2, 4), 'c', ...
    number_of_op, reward_total_box(:, 3, 4), 'g', ...
    number_of_op, reward_total_box(:, 4, 4), 'm');
legend('Noise = 0', ...
    'Noise = 10%', ...
    'Noise = 20%', ...
    'Noise = 30%');
...
plot(number_of_op, reward_total_box(:, 1, 2), 'b--', ...
    number_of_op, reward_total_box(:, 2, 2), 'c--', ...
    number_of_op, reward_total_box(:, 3, 2), 'g--', ...
    number_of_op, reward_total_box(:, 4, 2), 'm--');
...
plot(number_of_op, reward_total_box(:, 1, 5), 'b', ...
    number_of_op, reward_total_box(:, 2, 5), 'c', ...
    number_of_op, reward_total_box(:, 3, 5), 'g', ...
    number_of_op, reward_total_box(:, 4, 5), 'm');
legend('Noise = 0', ...
    'Noise = 10%', ...
    'Noise = 20%', ...
    'Noise = 30%');
...
plot(number_of_op, reward_total_box(:, 1, 3), 'b--', ...
    number_of_op, reward_total_box(:, 2, 3), 'c--', ...
    number_of_op, reward_total_box(:, 3, 3), 'g--', ...
    number_of_op, reward_total_box(:, 4, 3), 'm--');
xlabel('Number of upload opportunities');
ylabel('Weighted overall utility');
