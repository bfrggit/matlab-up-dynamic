...
saveas(gcf, 'fig_3/half_ds_size_comp_asap.fig');
...
ylabel('Weighted overall utility');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_3/half_ds_size_comp_alg4.fig');
...
ylabel('Weighted overall utility');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_3/half_ds_size_comp_ga.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
	'Location', 'southeast');
saveas(gcf, 'fig_3/half_ds_size_comp_high_asap.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
	'Location', 'southeast');
saveas(gcf, 'fig_3/half_ds_size_comp_high_alg4.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
	'Location', 'southeast');
saveas(gcf, 'fig_3/half_ds_size_comp_high_ga.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_3/half_ds_size_comp_length_asap.fig');
...
ylabel('Time to complete all data collection (sec)');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_3/half_ds_size_comp_length_alg4.fig');
...
ylabel('Time to complete all data collection (sec)');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_3/half_ds_size_comp_length_ga.fig');
