...
for j = 1:nm_ds
    ...
    for k = 1:N_LOOP
        mat_prefix = sprintf( ...
            'config_dynamic/change_ds_size_2/%d/case_%d/', ...
            size_of_ds(j), k);
        loop_j = k + (j - 1)* N_LOOP;
...
saveas(gcf, 'fig/conf_ds_size_2_dynamic_asap.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
	'Location', 'southeast');
saveas(gcf, 'fig/conf_ds_size_2_dynamic_alg4.fig');
...
ylabel('Weighted overall utility');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig/conf_ds_size_2_dynamic_ga.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
	'Location', 'southeast');
saveas(gcf, 'fig_2/conf_ds_size_2_length_asap.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
	'Location', 'southeast');
saveas(gcf, 'fig_2/conf_ds_size_2_length_alg4.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
	'Location', 'southeast');
saveas(gcf, 'fig_2/conf_ds_size_2_length_ga.fig');

save('mat/conf_ds_size_2_dynamic.mat')
