...
for col = 0:col_max
    load(sprintf('mat/half_ds_size_dy_data_bigger_%d.mat', col));
    if col == 0
...
%     'First opportunity');
plot(size_of_ds, reward_total_box(:, 1, 4), 'b', ...
    size_of_ds, reward_total_box(:, 2, 4), 'co-', ...
    size_of_ds, reward_total_box(:, 3, 4), 'g+-', ...
    size_of_ds, reward_total_box(:, 4, 4), 'mx-', ...
    size_of_ds, reward_total_box(:, 6, 4), 'r*-');
legend('Noise = 0', ...
    'Noise = 10%', ...
    'Noise = 20%', ...
...
plot(size_of_ds, reward_total_box(:, 1, 2), 'b--', ...
    size_of_ds, reward_total_box(:, 2, 2), 'co--', ...
    size_of_ds, reward_total_box(:, 3, 2), 'g+--', ...
    size_of_ds, reward_total_box(:, 4, 2), 'mx--', ...
    size_of_ds, reward_total_box(:, 6, 2), 'r*--');
xlabel('Average size of data chunks (KB)');
ylabel('Weighted overall utility');
saveas(gcf, 'fig_3/half_ds_size_x_dy_data_bigger_level_alg4.fig');
...
%     'First opportunity');
plot(size_of_ds, reward_total_box(:, 1, 5), 'b', ...
    size_of_ds, reward_total_box(:, 2, 5), 'co-', ...
    size_of_ds, reward_total_box(:, 3, 5), 'g+-', ...
    size_of_ds, reward_total_box(:, 4, 5), 'mx-', ...
    size_of_ds, reward_total_box(:, 6, 5), 'r*-');
legend('Noise = 0', ...
    'Noise = 10%', ...
    'Noise = 20%', ...
...
plot(size_of_ds, reward_total_box(:, 1, 3), 'b--', ...
    size_of_ds, reward_total_box(:, 2, 3), 'co--', ...
    size_of_ds, reward_total_box(:, 3, 3), 'g+--', ...
    size_of_ds, reward_total_box(:, 4, 3), 'mx--', ...
    size_of_ds, reward_total_box(:, 6, 3), 'r*--');
xlabel('Average size of data chunks (KB)');
ylabel('Weighted overall utility');
saveas(gcf, 'fig_3/half_ds_size_x_dy_data_bigger_level_ga.fig');
