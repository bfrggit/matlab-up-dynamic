...
saveas(gcf, 'fig/half_ds_size_dy_move_asap.fig');
...
ylabel('Weighted overall utility');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig/half_ds_size_dy_move_alg4.fig');
...
ylabel('Weighted overall utility');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig/half_ds_size_dy_move_ga.fig');
...
% legend('Strict static plan', 'Strict timeline', 'Control theory', ...
% 	'Location', 'southeast');
% saveas(gcf, 'fig_2/half_ds_size_dy_move_high_asap.fig');
...
% legend('Strict static plan', 'Strict timeline', 'Control theory', ...
% 	'Location', 'southeast');
% saveas(gcf, 'fig_2/half_ds_size_dy_move_high_alg4.fig');
...
% legend('Strict static plan', 'Strict timeline', 'Control theory', ...
% 	'Location', 'southeast');
% saveas(gcf, 'fig_2/half_ds_size_dy_move_high_ga.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_ds_size_dy_move_length_asap.fig');
...
ylabel('Time to complete all data collection (sec)');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_ds_size_dy_move_length_alg4.fig');
...
ylabel('Time to complete all data collection (sec)');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_2/half_ds_size_dy_move_length_ga.fig');

save('mat/half_ds_size_dy_move.mat')
