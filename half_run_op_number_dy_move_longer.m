...
for t_move_coef_10 = 0:1:5
    ...
    t_move_f = simu_t_move_exp_longer(t_move_coef);
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_move_longer_%d_asap.fig', ...
        t_move_coef_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_move_longer_%d_alg4.fig', ...
        t_move_coef_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_move_longer_%d_ga.fig', ...
        t_move_coef_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
      'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_move_longer_%d_high_asap.fig', ...
        t_move_coef_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
      'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_move_longer_%d_high_alg4.fig', ...
        t_move_coef_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
      'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_move_longer_%d_high_ga.fig', ...
        t_move_coef_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_move_longer_%d_length_asap.fig', ...
        t_move_coef_10));
    ...
    ylabel('Time to complete all data collection (sec)');
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_move_longer_%d_length_alg4.fig', ...
        t_move_coef_10));
    ...
    ylabel('Time to complete all data collection (sec)');
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_move_longer_%d_length_ga.fig', ...
        t_move_coef_10));

    save(sprintf('mat/half_op_number_dy_move_longer_%d.mat', t_move_coef_10))
end
