...
for data_change_hrp_10 = 0:1:5
    ...
    ds_data_change_f = simu_change_data_uniform_percent(data_change_hrp);
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_data_%d_asap.fig', ...
        data_change_hrp_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_data_%d_alg4.fig', ...
        data_change_hrp_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_data_%d_ga.fig', ...
        data_change_hrp_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_data_%d_high_asap.fig', ...
        data_change_hrp_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_data_%d_high_alg4.fig', ...
        data_change_hrp_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory', ...
        'Location', 'southeast');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_data_%d_high_ga.fig', ...
        data_change_hrp_10));
    ...
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_data_%d_length_asap.fig', ...
        data_change_hrp_10));
    ...
    ylabel('Time to complete all data collection (sec)');
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_data_%d_length_alg4.fig', ...
        data_change_hrp_10));
    ...
    ylabel('Time to complete all data collection (sec)');
    legend('Strict static plan', 'Strict timeline', 'Control theory');
    saveas(gcf, sprintf('fig_3/half_op_number_dy_data_%d_length_ga.fig', ...
        data_change_hrp_10));

    save(sprintf('mat/half_op_number_dy_data_%d.mat', data_change_hrp_10))
end
