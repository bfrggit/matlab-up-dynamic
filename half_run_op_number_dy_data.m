...
%     AP_RATE_MIN);
ds_data_change_f = @simu_change_data_0; % TODO
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
    'Location', 'southeast');
saveas(gcf, 'fig_3/half_op_number_dy_data_asap.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
    'Location', 'southeast');
saveas(gcf, 'fig_3/half_op_number_dy_data_alg4.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
    'Location', 'southeast');
saveas(gcf, 'fig_3/half_op_number_dy_data_ga.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
    'Location', 'southeast');
saveas(gcf, 'fig_3/half_op_number_dy_data_high_asap.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
    'Location', 'southeast');
saveas(gcf, 'fig_3/half_op_number_dy_data_high_alg4.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory', ...
    'Location', 'southeast');
saveas(gcf, 'fig_3/half_op_number_dy_data_high_ga.fig');
...
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_3/half_op_number_dy_data_length_asap.fig');
...
ylabel('Time to complete all data collection (sec)');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_3/half_op_number_dy_data_length_alg4.fig');
...
ylabel('Time to complete all data collection (sec)');
legend('Strict static plan', 'Strict timeline', 'Control theory');
saveas(gcf, 'fig_3/half_op_number_dy_data_length_ga.fig');

save('mat/half_op_number_dy_data.mat')
